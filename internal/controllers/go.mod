...
replace github.com/ArtefactGitHub/Go_P_Zo/internal/models => ../models/zo
...
require (
	...
	github.com/ArtefactGitHub/Go_P_Zo/internal/myerror v0.0.0-00010101000000-000000000000
