...
require (
	github.com/ArtefactGitHub/Go_P_Zo/internal/api/v1/user v0.0.0-20211226064812-51c406b24abe // indirect
	github.com/ArtefactGitHub/Go_P_Zo/internal/api/v1/zo v0.0.0-20211226064812-51c406b24abe // indirect
